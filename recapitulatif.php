...
<head>
    ...
    <title>R�capitulatif - Wild Safari</title>
...
<body>
    ...
    <main class="recap-container">
        <h2 style="color: #e67e22;">R�capitulatif de votre voyage</h2>
        ...
        <div class="actions">
            ...
            <a href="paiement.php?montant=<?= $voyage['prix'] ?? '' ?>" class="btn btn-payer">Proc�der au paiement</a>
        </div>
    </main>
